...
Krankmeldung f&uuml;r Mitarbeiter <?php echo $mitarbeiter ?>
<br><br>
<center>
 <a href="http://213.23.35.50/bedaplan/insert_ill.php?current_user=<?php echo $mitarbeiter ?>"  target="_blank"><img src="krank.jpg" border=0></a><br><br><br>
